...
<div class="chapters">
  ...
  <div class="part">
    ...
    <ul class="chapter-list">
      <li class="chapter-number"><?php echo __('Chapter 1'); ?></li>
      <li class="chapter-name">
          <a href="<?php echo public_url('exhibits/show/xianfeng-beijing'); ?>">
          <?php echo __('<em>Xianfeng</em> Beijing'); ?>
          </a>
      </li>
      <li class="chapter-number"><?php echo __('Chapter 2'); ?></li>
      <li class="chapter-name">
  ...
  <div class="part">
    ...
    <ul class="chapter-list">
      <li class="chapter-number"><?php echo __('Chapter 3'); ?></li>
      <li class="chapter-name">
          <a href="<?php echo public_url('exhibits/show/besieged-city'); ?>">
          <?php echo __('The Besieged City'); ?>
          </a>
      </li>
      <li class="chapter-number"><?php echo __('Chapter 4'); ?></li>
      <li class="chapter-name">
